...
<form action="add_file.jsp" enctype="multipart/form-data" method="post">
    업로드할 파일을 선택하세요.<br>
    <input type="file" name="upload1"><input type="text" name="name1"><br>
    <input type="file" name="upload2"><input type="text" name="name2"><br>
    <input type="file" name="upload3"><input type="text" name="name3"><br>
...
%>    
            <tr>
                <td class="left">
                    ...
                    <a href="File_Download.jsp?fname=<%=rs.getString("fname")%>"><%=rs.getString("fname")%></a>
                </td>
