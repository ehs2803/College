...
public class ch13_9 extends JFrame {
	public ch13_9() {
		super("스레드를 가진 겜블링");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setContentPane(new GamePanel_ch13_9()); // GamePanel을 컨텐트팬으로 등록한다. 
	...
	// 컨텐트팬을 사용되는 패널 클래스
	class GamePanel_ch13_9 extends JPanel {
