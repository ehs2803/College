...
print("\n1) np.zeros((n,m)) 메소드: 내부 원소 값이 모두 0인 2차원 n x m의 매트릭스 생성.")
...
# ---------------------------------------------------------------------------------------------
# 2) np.ones((n,m)) 함수: 내부 원소 값이 모두 1인 2차원 n x m의 매트릭스 생성.
# ..................................
...
print("\n2) np.ones((n,m)) 메소드: 내부 원소 값이 모두 1인 n x m의 매트릭스 생성.")
...
# ---------------------------------------------------------------------------------------------
# 3) np.ones((n,)) 함수: 내부 원소 값이 모두 1인 1차원 n x m의 매트릭스 생성.
# ..................................
# np.ones(shape, dtype=numpy.float64, order='C')
# ---------------------------------------------------------------------------------------------
print("\n3) np.ones((n, )) 메소드: 내부 원소 값이 모두 1인 1차원 매트릭스 생성.")
...
# ---------------------------------------------------------------------------------------------
# 4) np.empty((n, m)) 함수: 내부 원소가 초기화되지 않은 2차원 n x m 행렬 생성
# ..................................
...
print("\n4) np.empty((n, m)) 메소드: 내부 원소가 초기화되지 않은 2차원 n x m 행렬 생성")
...
# ---------------------------------------------------------------------------------------------
# 5) np.full((n, m), value) 함수: 내부 원소 값을 value로 지정하여 n x m 행렬 생성
# ..................................
...
# ---------------------------------------------------------------------------------------------
print("\n5) np.full((n, m), value) 메소드: 내부 원소 값을 모두 value인 2차원 n x m 행렬 생성")
...
# ---------------------------------------------------------------------------------------------
# 6) np.full_like(array, value) 함수: 샘플(사례)로 제시된 array와 같은 타입(크기, 데이터 타입)의
#   새로운 어레이를 생성하면서 특정값, value로 초기화를 행한다.
# ..................................
# full_like(a, fill_value, dtype=None, order='K', subok=True)
# Return a full array with the same shape and type as a given array.
# ---------------------------------------------------------------------------------------------
print("\n6) np.full_like(array, value) 메소드: 샘플(사례)로 제시된 array와 같은 타입(크기, 데이터 타입)의 새로운 어레이 반환")
x = np.arange(6, dtype=int)
print('np.arange(6, dtype=int)=>', x)         # np.arange(6, dtype=int)=> [0 1 2 3 4 5]
...
print("\nL6 = np.full_like(x, 2.1)"
      ": 지정한 value가 데이터형으로 초기화 되지 않고, 원본 어레이(x) 데이터 형으로 초기화된다. ")
print("L6 = np.full_like(x, 2.7)")
L6 = np.full_like(x, 2.7)     # X가 int이므로 2.7도 정수로 간주된다.
print_att('L6')


# ---------------------------------------------------------------------------------------------
# 7) np.empty_like(array) 함수: 샘플(사례)로 제시된 array와 같은 타입(크기, 데이터 타입)의
#   새로운 어레이를 생성하면서 초기화는 행하지 않는다.
# ---------------------------------------------------------------------------------------------
print("\n7) np.empty_like(array) 메소드: array와 같은 타입(크기, 데이터 타입)의 최기화되지 않은 어레이 반환")
x = np.zeros((8, 8))
x = np.ones((8, 8))
L7 = np.empty_like(x, dtype='uint8')
print_att('L7')
print(L7)
