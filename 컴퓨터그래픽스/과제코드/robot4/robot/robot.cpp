...
void MyLightInit() {
	...
	GLfloat light0_ambient[] = { 0.3f,0.3f,0.3f,1.0f }; //{ 0.25f, 0.25f, 0.0f, 1.0f }; //{ 0.5, 0.4, 0.3, 1.0 };     //조명 특성
	GLfloat light0_diffuse[] = { 0.7f,0.7f,0.7f,1.0f }; //{ 0.9f, 0.9f, 0.0f, 1.0f }; //{ 0.8, 0.7, 0.6, 1.0 };
...
void Render()
{
	...
	/*
	GLfloat LightPosition0[] = { 0.0, 5.0, -20.0, 1.0 };     //0번 광원위치
	//GLfloat LightPosition1[] = { 0.0, 0.0, 1.0, 1.0 };     //1번 광원위치
	GLfloat LightDirection1[] = { -0.5, -1.0, -1.0 };       //1번 광원 방향
	GLfloat SpotAngle1[] = { 30.0 };

	glLoadIdentity();                                       //항등행렬 로드
	//luLookAt(0.5, 0.5, 0.5, 0.0, 0.0, -1.0, 0.0, 1.0, 0.0);    //시점변환
	glTranslatef(0.3, 0.3, -30.0);                            //모델변환
	...
	*/
	...
	//glLightfv(GL_LIGHT0, GL_POSITION, LightPosition);
	glTranslatef(0.0, 0.0f, -30.0f);	// move to (0, 0, -30)
